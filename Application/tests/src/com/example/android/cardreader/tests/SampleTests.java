    ...
    */
    ...
    public void testBuildSelectApdu() {
        ...
        final byte[] expectedResult = {(byte) 0x00, (byte) 0xA4, 04, (byte) 0x00, (byte) 0x02,
                (byte) 0x12, (byte) 0x34};
        final byte[] result = BallotCardReader.BuildSelectApdu(aid);
    ...
    public void testHexToBinary() {
        ...
        final byte[] output = BallotCardReader.HexStringToByteArray("C0FFEE");
    ...
    public void testBinaryToHex() {
        ...
        final String output = BallotCardReader.ByteArrayToHexString(input);
